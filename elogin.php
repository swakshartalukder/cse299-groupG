...
<h4 id="h4ForUser"> Employee Panel </h4>
<br><br>
<form method="post" action="login.php">
<tr><td align="center" colspan="2"><input type="submit" value="Admin Log In" id="btn1"></td></tr>
</form>

<body background= "40.jpg">
...
<div class="login_form">
      ...
      <form method="post" action="elogin_backend.php">
